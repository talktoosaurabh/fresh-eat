         ...
         <div class="col-lg-12">
            <div class="lezada-form login-form" style="background:#2F4F4F;color:white;">
                @if(Session::has('flash_success_conact'))
                  ...
                  @endif
               <form method="POST" action="{{url('saveCorporateEnquiry')}}">
                  @csrf             
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="section-title section-title--login text-center mb-50">
                           <h2 class="mb-20" style="color:white;">Corporate Enquiry</h2>
                           <!--	<p>Complete the form below for a quote or reach out to us at </p> -->
                           <p>
                              ...
                              how best we can be of help to you.
                           </p>
                        </div>
                     </div>
                     <div class="col-lg-6">
